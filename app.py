...
# from utils.ats_score import ats_score,keyword_match,missing_skills
...
# st.markdown(
#     "Analyze resumes, compare with job descriptions, and prepare for interviews."
# )
...
#     # st.write(f"ATS Score: {ats}/100")

#     jd_match_score=keyword_match(jd_skills,skills)
#     # st.subheader("JD Score")
#     # st.write(f"✅ {jd_match_score}")

#     if jd_description:
        
#         se_match=semantic_match(text,jd_description)

#         st.subheader("Semantic Match Score")
#         st.write(f"✅ {se_match:.2f}%")
...
#     with col2:
#         st.metric("JD Match", f"{jd_match_score:.2f}%")

#     with col3:
#         st.metric("Semantic Match", f"{se_match:.2f}%")

#     missed_skills=missing_skills(jd_skills,skills)
...
#     interview_questions=get_ques(skills)
#     st.subheader("Interview Questions")
#     for ques in interview_questions:
#         st.write(f"✅ {ques}")

#     if st.button("Generate AI Feedback"):
#         feedback = gen_feedback(text,jd_description)
